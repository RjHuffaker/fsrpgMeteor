...
class FsDropdown {
	constructor($scope, $reactive, $element, $timeout, $document) {
		'ngInject';
		...
		var toggleHide = function(event){
			...
			console.log('this.dropdownId', this.dropdownId);
			for(elem; elem; elem = elem.parentNode){
				if(elem.dropdownId === this.dropdownId){
